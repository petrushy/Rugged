...
public class PythonLineDatation implements LineDatation {
     ...
     */
    @Override
    public native AbsoluteDate getDate(double lineNumber);
     ...
     */
    @Override
    public native double getLine(AbsoluteDate date);
     ...
     */
    @Override
    public native double getRate(double lineNumber);
}
